...
public class UserEventsDAO {
    ...
    public static int createUserEvents(String userID, String eventID, String eventType) throws ParseException, SQLException{
    ...
    public static int deleteUserEvents(String userEventID) throws SQLException {
